...
return array(
    'zfr_rest' => array(
        ...
        'listeners' => array(
            ...
            /**
             * If this listener is registered (it is by default), it allows you to return an object (an entity,
             * for instance) from a controller's action, and automatically serialize its content to an array. This
             * is especially useful if you specify a serializer into resource metadata. Please note that if you
             * deactivate this listener, you MUST NOT return a resource (entity...) from your controller, but an
             * array
             */
