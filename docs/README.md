...
5. [Built-in listeners](/docs/05. Built-in listeners.md)
    ...
    2. [HttpExceptionListener](/docs/05. Built-in listeners.md)
    3. [HttpMethodOverrideListener](/docs/05. Built-in listeners.md)

6. [View layer](/docs/06. View layer.md)
    1. [Customizing output](/docs/06. View layer.md)

7. [Cookbook](/docs/07. Cookbook.md)
    1. [How to implement the OPTIONS method?](/docs/07. Cookbook.md)
    2. [How to customize the payload?](/docs/07. Cookbook.md)
